...
import static io.ac.iot.ruleengine.event.RuleEngineEngineEventEnum.RULE_MODIFIED;
 ...
 **/
@Getter
public class RuleEngineModifiedEvent extends DomainEvent {
    ...
    public RuleEngineModifiedEvent(RuleEngine rule){
        super(RULE_MODIFIED);
        engineId = rule.getId();
